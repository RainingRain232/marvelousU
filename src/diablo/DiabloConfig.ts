...
export const PET_DEFS: Record<PetSpecies, DiabloPetDef> = {
  [PetSpecies.WOLF_PUP]: {
    ...
    baseHp: 80, baseDamage: 5, baseArmor: 5, moveSpeed: 6.5,
    attackRange: 2, attackSpeed: 1.2, aggroRange: 12,
    hpPerLevel: 15, damagePerLevel: 1.2, armorPerLevel: 1,
    abilities: [
  ...
  [PetSpecies.FIRE_SPRITE]: {
    ...
    baseHp: 50, baseDamage: 7, baseArmor: 2, moveSpeed: 5.5,
    attackRange: 10, attackSpeed: 0.8, aggroRange: 14,
    hpPerLevel: 10, damagePerLevel: 1.5, armorPerLevel: 0.5,
    abilities: [
  ...
  [PetSpecies.SHADOW_HOUND]: {
    ...
    baseHp: 100, baseDamage: 6, baseArmor: 8, moveSpeed: 7.0,
    attackRange: 2.5, attackSpeed: 1.0, aggroRange: 15,
    hpPerLevel: 18, damagePerLevel: 1.4, armorPerLevel: 1.5,
    abilities: [
  ...
  [PetSpecies.STORM_FALCON]: {
    ...
    baseHp: 60, baseDamage: 8, baseArmor: 3, moveSpeed: 8.0,
    attackRange: 8, attackSpeed: 1.5, aggroRange: 18,
    hpPerLevel: 8, damagePerLevel: 2, armorPerLevel: 0.5,
    abilities: [
  ...
  [PetSpecies.BONE_MINION]: {
    ...
    baseHp: 150, baseDamage: 3, baseArmor: 15, moveSpeed: 4.0,
    attackRange: 2, attackSpeed: 0.7, aggroRange: 10,
    hpPerLevel: 25, damagePerLevel: 0.8, armorPerLevel: 3,
    abilities: [
  ...
  [PetSpecies.SHIELD_GOLEM]: {
    ...
    baseHp: 200, baseDamage: 2, baseArmor: 20, moveSpeed: 3.5,
    attackRange: 2, attackSpeed: 0.5, aggroRange: 8,
    hpPerLevel: 30, damagePerLevel: 0.4, armorPerLevel: 4,
    abilities: [
  ...
  [PetSpecies.MANA_SPRITE]: {
    ...
    baseHp: 40, baseDamage: 3, baseArmor: 2, moveSpeed: 5.5,
    attackRange: 8, attackSpeed: 0.6, aggroRange: 0,
    hpPerLevel: 6, damagePerLevel: 0.8, armorPerLevel: 0.5,
    abilities: [
