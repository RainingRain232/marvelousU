...
export function buildCamelot(mctx: MapBuildContext, w: number, d: number): void {
    ...
    const buildingPositions: [number, number, number, number][] = [
      // [x, z, width, depth] — Inner ring (market district)
      ...
      // Outer ring — West side (residential quarter)
      [-35, -15, 3, 3], [-35, -8, 2.5, 3], [-35, 0, 3, 2.5], [-35, 8, 2.5, 3], [-35, 15, 3, 3],
      [-28, -12, 3, 2.5], [-28, -4, 2.5, 3], [-28, 5, 3, 3], [-28, 13, 2.5, 2.5],
      // Outer ring — East side (guild quarter)
      [35, -15, 3, 3], [35, -8, 2.5, 2.5], [35, 0, 3, 3], [35, 8, 3, 2.5], [35, 15, 2.5, 3],
      [28, -12, 2.5, 3], [28, -4, 3, 2.5], [28, 5, 2.5, 3], [28, 13, 3, 3],
      // Outer ring — South side (near gate)
      [-25, 28, 3, 3], [-15, 28, 2.5, 2.5], [-6, 28, 3, 3], [6, 28, 3, 2.5], [15, 28, 2.5, 3], [25, 28, 3, 3],
      [-20, 35, 2.5, 3], [-10, 35, 3, 2.5], [10, 35, 3, 3], [20, 35, 2.5, 2.5],
      // Outer ring — North side (near castle)
      [-30, -22, 3, 2.5], [-22, -22, 2.5, 3], [22, -22, 3, 3], [30, -22, 2.5, 2.5],
      // Corner buildings
      [-38, -35, 3, 3], [38, -35, 3, 3], [-38, 30, 2.5, 3], [38, 30, 3, 2.5],
    ];
