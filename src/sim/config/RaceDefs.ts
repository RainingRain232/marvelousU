...
export const RACE_DEFINITIONS: RaceDef[] = [
  ...
  },
  {
    ...
    factionUnits: [UnitType.WARCHIEF, UnitType.BOAR_RIDER, UnitType.SIEGE_TROLL, UnitType.BLOOD_BERSERKER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ARCHMAGE, UnitType.CHRONOMANCER, UnitType.SPELL_WEAVER, UnitType.MANA_WRAITH],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ELEMENTAL_AVATAR, UnitType.STORM_CONDUIT, UnitType.FROST_WYRM, UnitType.MAGMA_TITAN],
  ...
  },
  {
    ...
    factionUnits: [UnitType.PIRATE_CAPTAIN, UnitType.CORSAIR_GUNNER, UnitType.POWDER_MONKEY, UnitType.SEA_WITCH, UnitType.BOARDING_MASTER],
