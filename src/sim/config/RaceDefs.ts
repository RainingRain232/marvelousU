...
export const RACE_DEFINITIONS: RaceDef[] = [
  {
    ...
    factionUnits: [UnitType.HALBERDIER, UnitType.ROYAL_ARBALESTIER, UnitType.KNIGHT_COMMANDER, UnitType.WAR_CHAPLAIN, UnitType.SHIELD_CAPTAIN],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ELVEN_ARCHER, UnitType.BLADEDANCER, UnitType.TREANT_GUARDIAN, UnitType.MOONWEAVER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.WARCHIEF, UnitType.BOAR_RIDER, UnitType.SIEGE_TROLL, UnitType.BLOOD_BERSERKER, UnitType.HORDE_ARCHER, UnitType.HORDE_HEALER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ARCHMAGE, UnitType.CHRONOMANCER, UnitType.SPELL_WEAVER, UnitType.MANA_WRAITH, UnitType.BLADE_ADEPT],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ELEMENTAL_AVATAR, UnitType.STORM_CONDUIT, UnitType.FROST_WYRM, UnitType.MAGMA_TITAN, UnitType.STONE_FIST],
  ...
  },
  {
    ...
    factionUnits: [UnitType.HALFLING_SLINGER, UnitType.HALFLING_CHEF, UnitType.HALFLING_BURGLAR, UnitType.HALFLING_RIDER, UnitType.HALFLING_ALCHEMIST],
  ...
  },
  {
    ...
    factionUnits: [UnitType.MAGMA_GOLEM, UnitType.LAVA_SHAMAN, UnitType.OBSIDIAN_SENTINEL, UnitType.CINDER_WRAITH, UnitType.VOLCANIC_BEHEMOTH],
  ...
  },
  {
    ...
    factionUnits: [UnitType.DWARVEN_GUARDIAN, UnitType.RUNESMITH, UnitType.DWARVEN_CANNON, UnitType.IRONBREAKER, UnitType.THUNDERER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ORC_BRUTE, UnitType.ORC_DRUMMER, UnitType.ORC_SHAMAN, UnitType.WYVERN_RIDER, UnitType.PIT_FIGHTER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.DEATH_KNIGHT, UnitType.NECROMANCER, UnitType.BANSHEE, UnitType.BONE_COLOSSUS, UnitType.WRAITH_LORD],
  ...
  },
  {
    ...
    factionUnits: [UnitType.PIT_LORD, UnitType.HELLFIRE_WARLOCK, UnitType.SUCCUBUS, UnitType.DOOM_GUARD, UnitType.IMP_OVERLORD],
  ...
  },
  {
    ...
    factionUnits: [UnitType.SERAPHIM, UnitType.DIVINE_CHAMPION, UnitType.VALKYRIE, UnitType.ARCHON, UnitType.CELESTIAL_ARCHER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ALPHA_WOLF, UnitType.BEAST_SHAMAN, UnitType.THUNDERHAWK, UnitType.DIRE_BEAR, UnitType.SERPENT_PRIEST],
  ...
  },
  {
    ...
    factionUnits: [UnitType.WAR_GOLEM, UnitType.RUNE_CORE, UnitType.SIEGE_AUTOMATON, UnitType.CRYSTAL_GOLEM, UnitType.IRON_COLOSSUS],
  ...
  },
  {
    ...
    factionUnits: [UnitType.PIRATE_CAPTAIN, UnitType.CORSAIR_GUNNER, UnitType.POWDER_MONKEY, UnitType.SEA_WITCH, UnitType.BOARDING_MASTER, UnitType.BUCCANEER],
