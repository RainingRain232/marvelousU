...
export const RACE_DEFINITIONS: RaceDef[] = [
  {
    ...
    factionUnits: [UnitType.HALBERDIER, UnitType.ROYAL_ARBALESTIER, UnitType.KNIGHT_COMMANDER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ELVEN_ARCHER, UnitType.BLADEDANCER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.WARCHIEF, UnitType.BOAR_RIDER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ARCHMAGE, UnitType.CHRONOMANCER],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ELEMENTAL_AVATAR, UnitType.STORM_CONDUIT],
  ...
  },
  {
    ...
    factionUnits: [UnitType.HALFLING_SLINGER, UnitType.HALFLING_CHEF, UnitType.HALFLING_BURGLAR],
  ...
  },
  {
    ...
    factionUnits: [UnitType.MAGMA_GOLEM, UnitType.LAVA_SHAMAN, UnitType.OBSIDIAN_SENTINEL],
  ...
  },
  {
    ...
    factionUnits: [UnitType.DWARVEN_GUARDIAN, UnitType.RUNESMITH, UnitType.DWARVEN_CANNON],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ORC_BRUTE, UnitType.ORC_DRUMMER, UnitType.ORC_SHAMAN],
  ...
  },
  {
    ...
    factionUnits: [UnitType.DEATH_KNIGHT, UnitType.NECROMANCER, UnitType.BANSHEE],
  ...
  },
  {
    ...
    factionUnits: [UnitType.PIT_LORD, UnitType.HELLFIRE_WARLOCK, UnitType.SUCCUBUS],
  ...
  },
  {
    ...
    factionUnits: [UnitType.SERAPHIM, UnitType.DIVINE_CHAMPION, UnitType.VALKYRIE],
  ...
  },
  {
    ...
    factionUnits: [UnitType.ALPHA_WOLF, UnitType.BEAST_SHAMAN, UnitType.THUNDERHAWK],
  ...
  },
  {
    ...
    factionUnits: [UnitType.WAR_GOLEM, UnitType.RUNE_CORE, UnitType.SIEGE_AUTOMATON],
  ...
  },
  {
    ...
    factionUnits: [UnitType.PIRATE_CAPTAIN, UnitType.CORSAIR_GUNNER, UnitType.POWDER_MONKEY],
