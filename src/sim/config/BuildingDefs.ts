...
export const BUILDING_DEFINITIONS: Record<BuildingType, BuildingDef> = {
  ...
  [BuildingType.STABLES]: {
    ...
    hp: 200,
    goldIncome: 1,
    shopInventory: [UnitType.KNIGHT, UnitType.SIEGE_HUNTER, UnitType.HORSE_ARCHER, UnitType.SCOUT_CAVALRY, UnitType.LANCER, UnitType.ELITE_LANCER, UnitType.KNIGHT_LANCER],
    blueprints: [],
    footprint: { w: 2, h: 2 },
    placementZone: "own",
  },
  [BuildingType.MAGE_TOWER]: {
    ...
    hp: 150,
    goldIncome: 2,
    shopInventory: [UnitType.FIRE_MAGE, UnitType.STORM_MAGE, UnitType.SUMMONER, UnitType.COLD_MAGE, UnitType.DISTORTION_MAGE],
    blueprints: [],
    footprint: { w: 2, h: 2 },
    placementZone: "own",
  },
  [BuildingType.ARCHERY_RANGE]: {
    ...
    hp: 180,
    goldIncome: 1,
    shopInventory: [UnitType.ARCHER, UnitType.LONGBOWMAN, UnitType.CROSSBOWMAN, UnitType.SHORTBOW],
    blueprints: [],
    footprint: { w: 2, h: 2 },
    placementZone: "own",
  },
  [BuildingType.SIEGE_WORKSHOP]: {
    ...
    hp: 200,
    goldIncome: 1,
    shopInventory: [UnitType.BATTERING_RAM, UnitType.BALLISTA, UnitType.BOLT_THROWER],
    blueprints: [],
    footprint: { w: 2, h: 3 },
    placementZone: "own",
  },
