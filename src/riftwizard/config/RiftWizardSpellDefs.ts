...
export const SPELL_DEFS: Record<string, SpellDef> = {
  ...
  // 1. ARCANE - Chrono spell (time stop)
  temporal_shatter: {
    id: "temporal_shatter",
    ...
    slowDuration: 3,
    slowFactor: 0.0,
    description: "Fracture the flow of time itself, trapping all creatures in the blast in a frozen instant between heartbeats.",
    animationType: RWAnimationType.DISTORTION,
    upgrades: [
      { id: "ts2_dmg", name: "Entropy Surge", spCost: 2, description: "+12 damage", bonusDamage: 12 },
      { id: "ts2_aoe", name: "Temporal Rift", spCost: 2, description: "+1 AoE radius", bonusAoeRadius: 1 },
      { id: "ts2_dur", name: "Stasis Lock", spCost: 2, description: "+2 turns freeze duration", special: "slow_duration_2" },
      { id: "ts2_charges", name: "Chrono Reserve", spCost: 1, description: "+2 charges", bonusCharges: 2 },
    ],
  },

  // 2. DARK - Blood magic self-damage-for-power
  blood_pact: {
    id: "blood_pact",
    name: "Blood Pact",
    school: SpellSchool.DARK,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Carve a sigil into your own flesh and channel the spilled blood into a devastating curse that annihilates your target.",
    animationType: RWAnimationType.DEATH_BOLT,
    upgrades: [
      { id: "bp_dmg", name: "Exsanguinate", spCost: 2, description: "+20 damage (self-damage also increases by 5)", bonusDamage: 20 },
      { id: "bp_range", name: "Blood Trail", spCost: 1, description: "+3 range", bonusRange: 3 },
      { id: "bp_drain", name: "Vampiric Pact", spCost: 3, description: "Heal for 25% of damage dealt", special: "life_drain_25" },
      { id: "bp_charges", name: "Scarred Veins", spCost: 1, description: "+4 charges", bonusCharges: 4 },
    ],
  },

  // 3. LIGHTNING - Storm that chains and stuns
  tempest_lash: {
    id: "tempest_lash",
    name: "Tempest Lash",
    school: SpellSchool.LIGHTNING,
    ...
    maxBounces: 4,
    summonCount: 0,
    description: "Crack a whip of pure lightning across the battlefield; it leaps from foe to foe, leaving each one twitching and paralyzed.",
    animationType: RWAnimationType.CHAIN_LIGHTNING,
    upgrades: [
      { id: "tl_bounces", name: "Forked Tempest", spCost: 2, description: "+2 bounces", bonusBounces: 2 },
      { id: "tl_dmg", name: "Gigawatt Lash", spCost: 2, description: "+12 damage", bonusDamage: 12 },
      { id: "tl_stun", name: "Nerve Burn", spCost: 3, description: "Each hit stuns for 1 turn", special: "stun_1" },
      { id: "tl_charges", name: "Tempest Core", spCost: 1, description: "+3 charges", bonusCharges: 3 },
    ],
  },

  // 4. NATURE - Summon treants
  awaken_grove: {
    id: "awaken_grove",
    name: "Awaken Grove",
    school: SpellSchool.NATURE,
    ...
    maxBounces: 0,
    summonCount: 2,
    summonUnitType: "treant",
    description: "Whisper the old words into the earth and watch ancient trees tear free of the soil, hungry for vengeance.",
    animationType: RWAnimationType.SUMMON,
    upgrades: [
      { id: "ag_count", name: "Deep Forest", spCost: 2, description: "+1 treant per cast", bonusSummonCount: 1 },
      { id: "ag_charges", name: "Druid's Covenant", spCost: 1, description: "+2 charges", bonusCharges: 2 },
      { id: "ag_elder", name: "Elder Treant", spCost: 3, description: "Treants gain massive HP and thorns damage", special: "elder_treant" },
    ],
  },

  // 5. HOLY - Resurrection/revive
  resurrection: {
    id: "resurrection",
    name: "Resurrection",
    school: SpellSchool.HOLY,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Defy death itself. Bathe a fallen ally in golden light and drag their soul back from the threshold of oblivion.",
    animationType: RWAnimationType.HEAL,
    upgrades: [
      { id: "res_heal", name: "Full Restoration", spCost: 2, description: "+25 healing on revive", bonusDamage: -25 },
      { id: "res_charges", name: "Miracle Worker", spCost: 3, description: "+1 charge", bonusCharges: 1 },
      { id: "res_aoe", name: "Mass Resurrection", spCost: 4, description: "Revive all fallen allies in radius 3", bonusAoeRadius: 3 },
    ],
  },

  // 6. FIRE - Fire wall/barrier
  wall_of_flame: {
    id: "wall_of_flame",
    name: "Wall of Flame",
    school: SpellSchool.FIRE,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Erect a roaring curtain of fire that scorches any creature foolish enough to walk through it.",
    animationType: RWAnimationType.FIRE_AURA,
    upgrades: [
      { id: "wf_dmg", name: "White-Hot Barrier", spCost: 2, description: "+10 damage per turn", bonusDamage: 10 },
      { id: "wf_aoe", name: "Infernal Perimeter", spCost: 2, description: "+1 wall radius", bonusAoeRadius: 1 },
      { id: "wf_charges", name: "Eternal Pyre", spCost: 1, description: "+3 charges", bonusCharges: 3 },
      { id: "wf_burn", name: "Clinging Flames", spCost: 2, description: "Enemies passing through burn for 6 damage over 3 turns", special: "burn_6_3t" },
    ],
  },

  // 7. ICE - Mirror/reflection
  frost_mirror: {
    id: "frost_mirror",
    name: "Frost Mirror",
    school: SpellSchool.ICE,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Conjure a sheet of enchanted ice that reflects hostile magic back at its caster in a burst of frozen shards.",
    animationType: RWAnimationType.ICE_BALL,
    upgrades: [
      { id: "fm_dmg", name: "Sharpened Reflection", spCost: 2, description: "+12 damage", bonusDamage: 12 },
      { id: "fm_range", name: "Far Glass", spCost: 1, description: "+3 range", bonusRange: 3 },
      { id: "fm_charges", name: "Infinite Reflections", spCost: 1, description: "+3 charges", bonusCharges: 3 },
      { id: "fm_freeze", name: "Flash Freeze", spCost: 2, description: "Reflected targets are frozen for 2 turns", special: "freeze_duration_2" },
    ],
  },

  // 8. ARCANE - Gravity/void spell
  gravity_well: {
    id: "gravity_well",
    name: "Gravity Well",
    school: SpellSchool.ARCANE,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Tear a hole in reality that pulls all nearby creatures inward, crushing them under impossible gravitational force.",
    animationType: RWAnimationType.DISTORTION,
    upgrades: [
      { id: "gw_dmg", name: "Singularity", spCost: 2, description: "+12 damage", bonusDamage: 12 },
      { id: "gw_aoe", name: "Event Horizon", spCost: 2, description: "+1 AoE radius", bonusAoeRadius: 1 },
      { id: "gw_charges", name: "Void Reserves", spCost: 1, description: "+3 charges", bonusCharges: 3 },
    ],
  },

  // 9. DARK/NATURE - Plague/disease spreading
  creeping_plague: {
    id: "creeping_plague",
    ...
    maxBounces: 4,
    summonCount: 0,
    description: "Unleash a virulent contagion that leaps from host to host, rotting flesh and curdling blood wherever it spreads.",
    animationType: RWAnimationType.DEATH_BOLT,
    upgrades: [
      { id: "cp_bounces", name: "Pandemic", spCost: 2, description: "+2 bounces", bonusBounces: 2 },
      { id: "cp_dmg", name: "Necrotizing Strain", spCost: 2, description: "+10 damage", bonusDamage: 10 },
      { id: "cp_slow", name: "Weakening Disease", spCost: 2, description: "Infected targets are slowed for 2 turns", special: "plague_slow_2" },
      { id: "cp_charges", name: "Plague Reserves", spCost: 1, description: "+3 charges", bonusCharges: 3 },
    ],
  },

  // 10. HOLY - Chain heal bouncing between allies
  chain_of_light: {
    id: "chain_of_light",
    name: "Chain of Light",
    school: SpellSchool.HOLY,
    ...
    maxBounces: 3,
    summonCount: 0,
    description: "Release a ribbon of golden light that leaps between wounded allies, mending flesh and spirit with each arc.",
    animationType: RWAnimationType.HOLY_LIGHT,
    upgrades: [
      { id: "cl2_bounces", name: "Radiant Web", spCost: 1, description: "+2 bounces", bonusBounces: 2 },
      { id: "cl2_heal", name: "Greater Mending", spCost: 2, description: "+10 healing per bounce", bonusDamage: -10 },
      { id: "cl2_charges", name: "Wellspring", spCost: 1, description: "+3 charges", bonusCharges: 3 },
      { id: "cl2_shield", name: "Lingering Ward", spCost: 2, description: "Healed allies gain 5 shields", special: "heal_shield_5" },
    ],
  },

  // 11. FIRE - Volcanic eruption
  volcanic_eruption: {
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Split the earth beneath the rift and call forth rivers of magma that consume everything standing upon the ground.",
    animationType: RWAnimationType.EARTHQUAKE,
    upgrades: [
      { id: "ve_dmg", name: "Magma Surge", spCost: 2, description: "+15 damage", bonusDamage: 15 },
      { id: "ve_charges", name: "Tectonic Fury", spCost: 3, description: "+1 charge", bonusCharges: 1 },
      { id: "ve_burn", name: "Lava Pools", spCost: 2, description: "Leaves burning ground for 3 turns", special: "ground_fire_10_3t" },
    ],
  },

  // 12. ICE - Glacial prison
  glacial_prison: {
    id: "glacial_prison",
    name: "Glacial Prison",
    school: SpellSchool.ICE,
    ...
    slowDuration: 4,
    slowFactor: 0.0,
    description: "Encase a single enemy in a tomb of unbreakable ice, leaving them helpless and slowly freezing to death.",
    animationType: RWAnimationType.ICE_BALL,
    upgrades: [
      { id: "gp_dmg", name: "Crushing Ice", spCost: 1, description: "+10 damage", bonusDamage: 10 },
      { id: "gp_range", name: "Distant Frost", spCost: 1, description: "+3 range", bonusRange: 3 },
      { id: "gp_dur", name: "Eternal Prison", spCost: 2, description: "+2 turns freeze duration", special: "freeze_duration_2" },
      { id: "gp_charges", name: "Frost Warden", spCost: 1, description: "+5 charges", bonusCharges: 5 },
    ],
  },

  // 13. LIGHTNING - Ball lightning
  ball_lightning: {
    id: "ball_lightning",
    name: "Ball Lightning",
    school: SpellSchool.LIGHTNING,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Hurl a crackling sphere of condensed lightning that detonates on impact, electrocuting everything nearby.",
    animationType: RWAnimationType.CHAIN_LIGHTNING,
    upgrades: [
      { id: "bl_dmg", name: "Overloaded Sphere", spCost: 1, description: "+10 damage", bonusDamage: 10 },
      { id: "bl_aoe", name: "Discharge Wave", spCost: 2, description: "+1 AoE radius", bonusAoeRadius: 1 },
      { id: "bl_charges", name: "Charged Reserves", spCost: 1, description: "+5 charges", bonusCharges: 5 },
    ],
  },

  // 14. NATURE - Spore burst (poison AoE)
  spore_burst: {
    id: "spore_burst",
    name: "Spore Burst",
    school: SpellSchool.NATURE,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Launch a bloated fungal pod that erupts on impact, showering the area in toxic spores.",
    animationType: RWAnimationType.WEB,
    upgrades: [
      { id: "sb2_dmg", name: "Virulent Spores", spCost: 1, description: "+6 damage", bonusDamage: 6 },
      { id: "sb2_aoe", name: "Cloud Burst", spCost: 2, description: "+1 AoE radius", bonusAoeRadius: 1 },
      { id: "sb2_charges", name: "Mushroom Farm", spCost: 1, description: "+6 charges", bonusCharges: 6 },
    ],
  },

  // 15. DARK - Shadow fiend summon
  summon_shadow_fiend: {
    ...
    maxBounces: 0,
    summonCount: 1,
    summonUnitType: "shadow_fiend",
    description: "Reach into the abyss and pull forth a writhing fiend of living shadow that devours light and life alike.",
    animationType: RWAnimationType.SUMMON,
    upgrades: [
      { id: "ssf_count", name: "Legion of Shadows", spCost: 3, description: "+1 fiend per cast", bonusSummonCount: 1 },
      { id: "ssf_charges", name: "Shadow Covenant", spCost: 2, description: "+2 charges", bonusCharges: 2 },
      { id: "ssf_elite", name: "Abyssal Horror", spCost: 3, description: "Fiend gains life drain and fear aura", special: "elite_shadow_fiend" },
    ],
  },

  // 16. HOLY - Consecrated ground aura
  consecrated_ground: {
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Sanctify the earth beneath your feet, creating hallowed ground that mends allies and burns abominations.",
    animationType: RWAnimationType.HEAL,
    upgrades: [
      { id: "cg_heal", name: "Sacred Soil", spCost: 1, description: "+8 healing per turn", bonusDamage: -8 },
      { id: "cg_aoe", name: "Expanding Sanctum", spCost: 2, description: "+1 aura radius", bonusAoeRadius: 1 },
      { id: "cg_charges", name: "Blessed Reserves", spCost: 1, description: "+3 charges", bonusCharges: 3 },
      { id: "cg_smite", name: "Holy Ground", spCost: 2, description: "Undead on consecrated ground take 10 damage per turn", special: "ground_smite_10" },
    ],
  },

  // 17. ARCANE - Phase bolt (teleport + damage)
  phase_bolt: {
    id: "phase_bolt",
    name: "Phase Bolt",
    school: SpellSchool.ARCANE,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Fire a bolt that blinks through solid matter, ignoring all obstacles to strike its target from an impossible angle.",
    animationType: RWAnimationType.MAGIC_MISSILE,
    upgrades: [
      { id: "pb_dmg", name: "Dimensional Strike", spCost: 1, description: "+8 damage", bonusDamage: 8 },
      { id: "pb_range", name: "Phase Reach", spCost: 1, description: "+3 range", bonusRange: 3 },
      { id: "pb_charges", name: "Rift Siphon", spCost: 1, description: "+8 charges", bonusCharges: 8 },
    ],
  },

  // 18. LIGHTNING - Static field aura
  static_field: {
    id: "static_field",
    name: "Static Field",
    school: SpellSchool.LIGHTNING,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Wreathe yourself in a crackling electric field that shocks anything that draws near.",
    animationType: RWAnimationType.CHAIN_LIGHTNING,
    upgrades: [
      { id: "sf_dmg", name: "High Voltage Field", spCost: 2, description: "+8 damage per turn", bonusDamage: 8 },
      { id: "sf_aoe", name: "Expanding Field", spCost: 2, description: "+1 aura radius", bonusAoeRadius: 1 },
      { id: "sf_charges", name: "Capacitor", spCost: 1, description: "+2 charges", bonusCharges: 2 },
      { id: "sf_stun", name: "Taser Field", spCost: 3, description: "Enemies in field are stunned for 1 turn on entry", special: "stun_1" },
    ],
  },

  // 19. NATURE - Summon ice elementals
  summon_ice_elemental: {
    id: "summon_ice_elemental",
    ...
    maxBounces: 0,
    summonCount: 1,
    summonUnitType: "ice_elemental",
    description: "Bind the essence of winter into a hulking elemental of living ice that freezes the ground wherever it treads.",
    animationType: RWAnimationType.SUMMON,
    upgrades: [
      { id: "sie_count", name: "Winter Court", spCost: 2, description: "+1 elemental per cast", bonusSummonCount: 1 },
      { id: "sie_charges", name: "Permafrost Pact", spCost: 1, description: "+2 charges", bonusCharges: 2 },
      { id: "sie_elite", name: "Frost Colossus", spCost: 3, description: "Elemental gains freezing aura and massive HP", special: "frost_colossus" },
    ],
  },

  // 20. FIRE - Immolation cone
  immolation: {
    id: "immolation",
    name: "Immolation",
    school: SpellSchool.FIRE,
    ...
    maxBounces: 0,
    summonCount: 0,
    description: "Ignite the very air before you in a fanning wave of superheated flame that melts armor and chars bone.",
    animationType: RWAnimationType.FIRE_BREATH,
    upgrades: [
      { id: "imm_dmg", name: "Cremation", spCost: 2, description: "+12 damage", bonusDamage: 12 },
      { id: "imm_range", name: "Long Burn", spCost: 1, description: "+1 cone range", bonusRange: 1 },
      { id: "imm_charges", name: "Fuel Reserves", spCost: 1, description: "+4 charges", bonusCharges: 4 },
      { id: "imm_ignite", name: "Spontaneous Combustion", spCost: 2, description: "Killed enemies explode for 10 damage to adjacent tiles", special: "death_explosion_10" },
    ],
  },
};
