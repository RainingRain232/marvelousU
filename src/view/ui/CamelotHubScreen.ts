...
const MAP_BUILDINGS: MapBuilding[] = [
  ...
  // ── Additional game modes (houses, wall towers, compact buildings) ──
  { id: "shadow_house", x: 420, y: 160, w: 60, h: 50, label: "Shadow Den", mode: GameMode.SHADOWHAND, type: "tower" },
  { id: "alchemist_lab", x: 200, y: 350, w: 70, h: 55, label: "Alchemist's Lab", mode: GameMode.ALCHEMIST, type: "tower" },
  { id: "siege_works", x: 80, y: 160, w: 80, h: 60, label: "Siege Works", mode: GameMode.SIEGE, type: "forge" },
  { id: "tavern_cellar", x: 640, y: 600, w: 70, h: 50, label: "The Tavern Cellar", mode: GameMode.TAVERN, type: "tavern" },
  { id: "hunt_lodge", x: 80, y: 720, w: 70, h: 55, label: "Hunter's Lodge", mode: GameMode.HUNT, type: "stable" },
  { id: "race_track", x: 870, y: 650, w: 70, h: 55, label: "The Race Track", mode: GameMode.RACE, type: "stable" },
  { id: "round_table", x: 560, y: 300, w: 80, h: 60, label: "The Round Table", mode: GameMode.ROUND_TABLE, type: "library" },
  { id: "ascent_tower", x: 250, y: 100, w: 60, h: 55, label: "The Ascent", mode: GameMode.CAMELOT_ASCENT, type: "tower" },
  { id: "block_yard", x: 920, y: 450, w: 70, h: 55, label: "The Block Yard", mode: GameMode.GRAIL_BLOCKS, type: "forge" },
  { id: "derby_ring", x: 1000, y: 650, w: 70, h: 55, label: "The Derby Ring", mode: GameMode.GRAIL_DERBY, type: "stable" },
  { id: "breaker_hall", x: 770, y: 370, w: 70, h: 55, label: "Breaker Hall", mode: GameMode.GRAIL_BREAKER, type: "forge" },
  { id: "necro_sanctum", x: 200, y: 630, w: 70, h: 55, label: "Necromancer's Sanctum", mode: GameMode.NECROMANCER, type: "church" },
  { id: "bard_stage", x: 540, y: 500, w: 70, h: 50, label: "The Bard's Stage", mode: GameMode.BARD, type: "tavern" },
  { id: "hilltop_fort", x: 1000, y: 400, w: 70, h: 55, label: "Hilltop Fort", mode: GameMode.KOTH, type: "tower" },
  { id: "chrono_tower", x: 350, y: 100, w: 60, h: 55, label: "Chrono Tower", mode: GameMode.CHRONOMANCER, type: "tower" },
  { id: "shifting_den", x: 1150, y: 380, w: 60, h: 50, label: "The Shifting Den", mode: GameMode.SHAPESHIFTER, type: "tower" },
  { id: "void_passage", x: 1150, y: 500, w: 70, h: 55, label: "Void Passage", mode: GameMode.VOIDWALKER, type: "tower" },
  { id: "gargoyle_perch", x: 450, y: 100, w: 60, h: 50, label: "Gargoyle Perch", mode: GameMode.GARGOYLE, type: "tower" },
  { id: "lot_chamber", x: 680, y: 450, w: 60, h: 50, label: "Lot's Chamber", mode: GameMode.LOT, type: "library" },
  { id: "guinevere_garden", x: 480, y: 400, w: 70, h: 55, label: "Guinevere's Garden", mode: GameMode.GUINEVERE, type: "church" },
  { id: "depth_well", x: 500, y: 660, w: 60, h: 55, label: "The Depths", mode: GameMode.DEPTHS, type: "tower" },
  { id: "rampart_wall", x: 1150, y: 600, w: 70, h: 55, label: "The Ramparts", mode: GameMode.RAMPART, type: "tower" },
  // ── Wall tower game modes (placed along the outer walls) ──
  { id: "joust_field", x: 400, y: 770, w: 80, h: 55, label: "Jousting Field", mode: GameMode.JOUSTING, type: "training" },
  { id: "labyrinth_gate", x: 140, y: 770, w: 80, h: 55, label: "The Labyrinth", mode: GameMode.LABYRINTH, type: "gate" },
  { id: "plague_ward", x: 260, y: 770, w: 70, h: 50, label: "Plague Ward", mode: GameMode.PLAGUE, type: "tower" },
  { id: "plague_tower", x: 980, y: 770, w: 70, h: 50, label: "Plague Tower", mode: GameMode.PLAGUE_RT, type: "tower" },
  { id: "wonders_gate", x: 1100, y: 770, w: 80, h: 55, label: "Gate of Wonders", mode: GameMode.AGE_OF_WONDERS, type: "gate" },
  { id: "lancelot_arena", x: 50, y: 400, w: 70, h: 55, label: "Lancelot's Arena", mode: GameMode.LANCELOT, type: "colosseum" },
  { id: "sewer_grate", x: 700, y: 680, w: 70, h: 50, label: "Sewer Grate", mode: GameMode.SEWER_SPLASH, type: "gate" },
  { id: "avalon_lake", x: 750, y: 50, w: 80, h: 55, label: "Lake of Avalon", mode: GameMode.LAKE_OF_AVALON, type: "harbor" },
  { id: "trebuchet_yard", x: 50, y: 280, w: 70, h: 55, label: "Trebuchet Yard", mode: GameMode.TREBUCHET, type: "forge" },
