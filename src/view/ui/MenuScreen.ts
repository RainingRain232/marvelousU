...
export class MenuScreen {
  ...
  private _buildScreen1(): void {
    ...
    const categories: { title: string; icon: string; color: number; accent: number; indices: number[] }[] = [
      ...
      { title: "3D ACTION & COMBAT", icon: "\u{1F6E1}", color: 0xff7744, accent: 0x2a1408, indices: [11, 15, 12, 13, 14, 16, 17, 29, 68, 71, 72, 73, 80, 82, 84, 85, 86, 87] },
      { title: "WORLDS & SPORTS", icon: "\u{1F30D}", color: 0x6699ff, accent: 0x0a1a2a, indices: [19, 20, 23, 24, 25, 26, 27, 30, 39, 40, 43, 44, 45, 69, 78, 79, 81, 83] },
    ];
