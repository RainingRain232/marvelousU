...
const UNIT_LABELS: Record<UnitType, string> = {
  ...
  [UnitType.HALFLING_SLINGER]: "Halfling Slinger",
  [UnitType.HALFLING_CHEF]: "Halfling Chef",
  [UnitType.MAGMA_GOLEM]: "Magma Golem",
  [UnitType.LAVA_SHAMAN]: "Lava Shaman",
  [UnitType.DWARVEN_GUARDIAN]: "Dwarven Guardian",
  [UnitType.RUNESMITH]: "Runesmith",
  [UnitType.ORC_BRUTE]: "Orc Brute",
  [UnitType.ORC_DRUMMER]: "Orc Drummer",
  [UnitType.DEATH_KNIGHT]: "Death Knight",
  [UnitType.NECROMANCER]: "Necromancer",
  [UnitType.PIT_LORD]: "Pit Lord",
  [UnitType.HELLFIRE_WARLOCK]: "Hellfire Warlock",
  [UnitType.SERAPHIM]: "Seraphim",
  [UnitType.DIVINE_CHAMPION]: "Divine Champion",
  [UnitType.ALPHA_WOLF]: "Alpha Wolf",
  [UnitType.BEAST_SHAMAN]: "Beast Shaman",
  [UnitType.WAR_GOLEM]: "War Golem",
  ...
  [UnitType.WAR_CHAPLAIN]: "War Chaplain",
  [UnitType.SHIELD_CAPTAIN]: "Shield Captain",
  [UnitType.TREANT_GUARDIAN]: "Treant Guardian",
  [UnitType.MOONWEAVER]: "Moonweaver",
  [UnitType.SIEGE_TROLL]: "Siege Troll",
  [UnitType.BLOOD_BERSERKER]: "Blood Berserker",
  [UnitType.SPELL_WEAVER]: "Spell Weaver",
  [UnitType.MANA_WRAITH]: "Mana Wraith",
  [UnitType.FROST_WYRM]: "Frost Wyrm",
  [UnitType.MAGMA_TITAN]: "Magma Titan",
  [UnitType.HALFLING_RIDER]: "Halfling Rider",
  [UnitType.HALFLING_ALCHEMIST]: "Halfling Alchemist",
  [UnitType.CINDER_WRAITH]: "Cinder Wraith",
  [UnitType.VOLCANIC_BEHEMOTH]: "Volcanic Behemoth",
  [UnitType.IRONBREAKER]: "Ironbreaker",
  [UnitType.THUNDERER]: "Thunderer",
  [UnitType.WYVERN_RIDER]: "Wyvern Rider",
  [UnitType.PIT_FIGHTER]: "Pit Fighter",
  [UnitType.BONE_COLOSSUS]: "Bone Colossus",
  [UnitType.WRAITH_LORD]: "Wraith Lord",
  [UnitType.DOOM_GUARD]: "Doom Guard",
  [UnitType.IMP_OVERLORD]: "Imp Overlord",
  [UnitType.ARCHON]: "Archon",
  [UnitType.CELESTIAL_ARCHER]: "Celestial Archer",
  [UnitType.DIRE_BEAR]: "Dire Bear",
  [UnitType.SERPENT_PRIEST]: "Serpent Priest",
  [UnitType.CRYSTAL_GOLEM]: "Crystal Golem",
