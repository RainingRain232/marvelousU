...
export const G = {
  ...
  SPLITTER_SPEED: 50, SPLITTER_HP: 2, SPLITTER_RADIUS: 8, SPLITTER_SPLIT_COUNT: 2,
  MINI_SPEED: 80, MINI_HP: 1, MINI_RADIUS: 5,
  PHASER_SPEED: 70, PHASER_HP: 1, PHASER_RADIUS: 7, PHASER_TELEPORT_INTERVAL: 3.0, PHASER_TELEPORT_RANGE: 80,

  // Waves
  WAVE_INTERVAL: 20,
  WAVE_EVENT_INTERVAL: 3, // event every 3rd wave
  BLITZ_DURATION: 10,     // seconds of double spawn rate
  BLITZ_SPEED_MULT: 1.5,  // speed multiplier during blitz
  ...
  SCORE_KILL_TANK: 40,
  SCORE_KILL_SPLITTER: 25,
  SCORE_KILL_PHASER: 30,
  SCORE_KILL_MINI: 5,
  SCORE_CAPTURE: 2,
  ...
  COLOR_ENEMY_SPLITTER: 0x44cc44,
  COLOR_ENEMY_PHASER: 0x44ffee,
  COLOR_ENEMY_MINI: 0xff4444,
  ...
  POWERUP_LIFETIME: 8,
  POWERUP_COLLECT_RADIUS: 15,
  SHIELD_DURATION: 3,
  MAGNET_DURATION: 10,
  MAGNET_MULT: 1.5,
  RAPID_DURATION: 8,
  PERFECT_WAVE_BONUS: 50,
  COLOR_POWERUP_SHIELD: 0x44ffff,
  COLOR_POWERUP_MAGNET: 0xaa44ff,
  COLOR_POWERUP_RAPID: 0xffaa44,
} as const;
