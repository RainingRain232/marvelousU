...
export const UNITS: Record<UnitType, UnitDef> = {
  swordsman: {
    ...
    color: 0x886644, size: 8, shape: "circle",
  ...
  archer: {
    ...
    color: 0x448844, size: 7, shape: "triangle",
  ...
  pikeman: {
    ...
    color: 0x666688, size: 9, shape: "square",
  ...
  cavalry: {
    ...
    color: 0xaa7744, size: 11, shape: "diamond",
  ...
  mage: {
    ...
    color: 0x6644aa, size: 7, shape: "star",
  ...
  berserker: {
    ...
    color: 0xcc4422, size: 10, shape: "diamond",
  ...
  crossbow: {
    ...
    color: 0x557744, size: 7, shape: "triangle",
  ...
  paladin: {
    ...
    color: 0xddcc44, size: 11, shape: "hex",
