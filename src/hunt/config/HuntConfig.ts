...
export const PREY: Record<PreyType, PreyDef> = {
  rabbit:   { id: "rabbit",   name: "Rabbit",   hp: 1, speed: 100, value: 5,  color: 0xaa8866, size: 4,  fleeSpeed: 180, awareness: 0.3, penalty: false },
  pheasant: { id: "pheasant", name: "Pheasant", hp: 1, speed: 60,  value: 8,  color: 0x886644, size: 5,  fleeSpeed: 200, awareness: 0.5, penalty: false },
  fox:      { id: "fox",      name: "Fox",      hp: 1, speed: 90,  value: 12, color: 0xcc6622, size: 5,  fleeSpeed: 160, awareness: 0.6, penalty: false },
  deer:     { id: "deer",     name: "Deer",     hp: 2, speed: 70,  value: 15, color: 0xaa8844, size: 7,  fleeSpeed: 150, awareness: 0.4, penalty: false },
  boar:     { id: "boar",     name: "Boar",     hp: 3, speed: 50,  value: 20, color: 0x664422, size: 8,  fleeSpeed: 80,  awareness: 0.2, penalty: false },
  stag:     { id: "stag",     name: "Royal Stag", hp: 2, speed: 80, value: 30, color: 0xddaa44, size: 8, fleeSpeed: 170, awareness: 0.7, penalty: false },
  wolf:     { id: "wolf",     name: "Wolf",     hp: 2, speed: 85,  value: 25, color: 0x777788, size: 6,  fleeSpeed: 120, awareness: 0.5, penalty: false },
  bear:     { id: "bear",     name: "Bear",     hp: 5, speed: 40,  value: 40, color: 0x553322, size: 10, fleeSpeed: 60,  awareness: 0.3, penalty: false },
};
