...
export const CORPSES: Record<CorpseType, CorpseDef> = {
  peasant:  { id: "peasant",  name: "Peasant",  hp: 3,  damage: 1, speed: 40, manaCost: 5,  color: 0x667766, weight: 5, size: 6 },
  soldier:  { id: "soldier",  name: "Soldier",  hp: 6,  damage: 2, speed: 35, manaCost: 10, color: 0x778888, weight: 3, size: 7 },
  knight:   { id: "knight",   name: "Knight",   hp: 10, damage: 3, speed: 30, manaCost: 18, color: 0x8899aa, weight: 2, size: 8 },
  mage:     { id: "mage",     name: "Dead Mage", hp: 4, damage: 5, speed: 25, manaCost: 22, color: 0x9966cc, weight: 1, size: 6 },
  noble:    { id: "noble",    name: "Noble",    hp: 5,  damage: 1, speed: 20, manaCost: 8,  color: 0xccaa66, weight: 2, size: 7 },
};
...
export type CrusaderType = "footman" | "templar" | "paladin" | "priest" | "banner";
...
export interface CrusaderDef {
  ...
  reward: number;
  /** Special ability */
  ability?: "heal_aura" | "holy_smite" | "rally" | "shield_wall";
}
...
export const WAVES: WaveEntry[][] = [
  ...
  // Wave 7
  [{ type: "templar", count: 4 }, { type: "paladin", count: 2 }, { type: "priest", count: 2 }, { type: "banner", count: 1 }],
  // Wave 8 — final boss
  [{ type: "paladin", count: 3 }, { type: "priest", count: 2 }, { type: "banner", count: 2 }, { type: "templar", count: 4 }],
];
